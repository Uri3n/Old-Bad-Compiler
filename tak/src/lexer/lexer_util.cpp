...
lexer_token_type_to_string(token_t type) {
    ...
    switch(type) {
        ...
        case COMP_LT:                return "Less-Than Operator";
        case COMP_LTE:               return "Less-Than-Or-Equals Operator";
        case COMP_GT:                return "Greater-Than Operator";
        case COMP_GTE:               return "Greater-Than-Or-Equals Operator";
        case CONDITIONAL_AND:        return "Conditional AND Operator";
        case CONDITIONAL_OR:         return "Conditional OR Operator";
        case CONDITIONAL_NOT:        return "Conditional NOT Operator";
        ...
        case PLUSEQ:                 return "Addition-Equals Operator";
        case SUB:                    return "Subtraction Operator";
        case SUBEQ:                  return "Subtraction-Equals Operator";
        case MUL:                    return "Multiplication Operator";
        case MULEQ:                  return "Multiplication-Equals Operator";
        case DIV:                    return "Division Operator";
        case DIVEQ:                  return "Division-Equals Operator";
        case MOD:                    return "Modulus Operator";
        case MODEQ:                  return "Modulus-Equals Operator";
        ...
        case BITWISE_OREQ:           return "Bitwise OR-Equals Operator";
        case BITWISE_XOR_OR_PTR:     return "Bitwise XOR Operator Or Pointer";
        case BITWISE_XOREQ:          return "Bitwise XOR-Equals Operator";
        case BITWISE_LSHIFT:         return "Left Bitshift Operator";
        case BITWISE_RSHIFT:         return "Right Bitshift Operator";
