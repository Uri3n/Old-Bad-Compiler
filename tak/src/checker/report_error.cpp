...
void
tak::CheckerContext::raise_error(const std::string& message, const size_t position) {
...
void
tak::CheckerContext::raise_warning(const std::string& message, const size_t position) {
